...
gword coco3_relays[] gSETUP_DATA = {
    0xFEEE, 0xFEF1, 0xFEF4, 0xFEF7, 0xFEFA, 0xFEFD,
};
...
#define SetupPrint(STRING)                                 \
  {                                                        \
    static char SS_##STRING[] gSETUP_DATA = "" #STRING ""; \
    ColdPrint(SS_##STRING);                                \
  }
...
void embark(void) {
  ...
  memset_words((gword)&_Final, 0x3F3F,
               ((gword)&_Final_Startup - (gword)&_Final) >> 1);
