...
#ifndef _KERNEL_W5100S_DEFS_H_
#define _KERNEL_W5100S_DEFS_H_
...
/*
                              ...
                              ; 0x0000 - 0x002F Common Registers W5100
   compatible ; 0x0030 - 0x0088 Common Registers New W5100S ; 0x0089 - 0x03FF --
   Reserved -- ; 0x0400 - 0x04FF Socket 0 Registers ; 0x0500 - 0x05FF Socket 1
   Registers ; 0x0600 - 0x06FF Socket 2 Registers ; 0x0700 - 0x07FF Socket 3
   Registers ; 0x0800 - 0x3FFF -- Reserved -- ; 0x4000 - 0x5FFF TX Memory -
   default 2KB per socket ; 0x6000 - 0x7FFF RX Memory - default 2KB per socket
*/
...
#define SKREGABS(k, r) \
  (SKREGADR(k) + r) /* Sock k Register r Address Absolute */
#define SKREGREL(o, r) \
  (SKREGBASE + o + r) /* Sock k Register r Address Relative */
