...
void PMode1DrawHorz(gbyte* fb, SpotDrawer draw, gbyte x, gbyte y, gbyte color, gbyte len) {
    gbyte limit = x + len;
...
void PMode1DrawVirt(gbyte* fb, SpotDrawer draw, gbyte x, gbyte y, gbyte color, gbyte len) {
    gbyte limit = y + len;
