...
void PMode1DrawDigit3x5(gbyte* fb, SpotDrawer draw, gbyte x, gbyte y,
                        gbyte color, gbyte digit) {
...
gbyte PMode1DrawDecimal3x5Unsigned(gbyte* fb, SpotDrawer draw, gbyte x, gbyte y,
                                   gbyte color, gword val) {
...
void PMode1DrawDecimal3x5(gbyte* fb, SpotDrawer draw, gbyte x, gbyte y,
                          gbyte color, int val) {
  if (val < 0) {
...
// x,y is NW corner.  20 wide, 5 deep.
void PMode1ClearDecimal3x5Unsigned(gbyte* fb, SpotDrawer draw, gbyte x, gbyte y,
                                   gbyte color) {
  for (gbyte i = 0; i < 5; i++) {
...
// x,y is NW corner.  24 wide, 5 deep.
void PMode1ClearDecimal3x5(gbyte* fb, SpotDrawer draw, gbyte x, gbyte y,
                           gbyte color) {
  for (gbyte i = 0; i < 5; i++) {
